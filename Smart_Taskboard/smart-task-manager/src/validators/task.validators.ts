...
export const createTaskValidators: ValidationChain[] = [
...
export const changeStatusValidators: ValidationChain[] = [
  body('status').isIn(['TODO', 'IN_PROGRESS', 'DONE']).withMessage('Invalid status value'),
];

export const assignUsersValidators: ValidationChain[] = [
